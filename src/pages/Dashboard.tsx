        ...
        <div className="grid lg:grid-cols-5 gap-6">
                  ...
                  <div key={stat.subject} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${subjectGradients[stat.subject]} flex items-center justify-center text-sm`}>
          ...
          >
            ...
            {quickActions.map((action, i) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${action.gradient} flex items-center justify-center text-white text-xl shrink-0 shadow-md group-hover:scale-105 transition-transform`}>
                  {action.emoji}
                </div>
